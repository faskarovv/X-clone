...
public class PostController {
    ...
    public ResponseEntity<List<PostDto.response>> getPostByUserId(@PathVariable Long userId){

        List<PostDto.response> responseList = postService.getPostsByUserId(userId);
